...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse h-100 w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
        <a class="nav-link <?php echo (basename($_SERVER['PHP_SELF']) == 'course' || basename($_SERVER['PHP_SELF']) == 'editmodul.php' || basename($_SERVER['PHP_SELF']) == 'detailmodul.php' || basename($_SERVER['PHP_SELF']) == 'tambahmateri.php' || basename($_SERVER['PHP_SELF']) == 'previewsubbab.php') ? 'active' : ''; ?>" href="../pages/course">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
...
if (isset($_GET['id_subbab'])) {
    ...
    if ($data_subbab) {
        ...
        echo '<h6 class="ms-4 mb-3">- ' . $nama_subbab . '</h6>';
    } else {
...
if (isset($_GET['id_subbab'])) {
    ...
    // Query untuk mendapatkan semua data materi berdasarkan ID subbab
    $stmt = $koneksi->prepare("SELECT * FROM tb_materi WHERE id_subbab = ?");
    $stmt->execute([$id_subbab]);
