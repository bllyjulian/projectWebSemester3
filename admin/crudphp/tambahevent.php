                ...
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" required name="keterangan" id="keterangan" placeholder=""
                        autocomplete="off">
                    </div>

                    <div class="form-group">
                      <label class="text-lg font-weight-bold" for="lokasi">Lokasi</label>
                      <input type="text" class="form-control" required name="lokasi" id="lokasi" placeholder=""
                        autocomplete="off">
                    </div>
                    <div class="form-group">
                      <label class="text-lg font-weight-bold" for="gambar">Poster</label>
                      <input type="file" class="form-control" required name="gambar" id="gambar" placeholder=""
                        autocomplete="off">
                    </div>
                    <!-- <div class="form-group">
        <label class="text-lg font-weight-bold" for="gambar">Poster</label>
        <input type="file" class="form-control" required name="gambar" id="gambar" placeholder="" autocomplete="off">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" required name="kuota" id="kuota" placeholder=""
                        autocomplete="off">
                    </div>
