  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="collapse navbar-collapse h-100 w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link <?php echo (basename($_SERVER['PHP_SELF']) == 'course' || basename($_SERVER['PHP_SELF']) == 'course.php' || basename($_SERVER['PHP_SELF']) == 'editmodul.php') ? 'active' : ''; ?>"
            href="../pages/course">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" required name="judul" id="judul"
                            value="<?= $data_modul['judul']; ?>" autocomplete="off">
                        </div>
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" required name="keterangan" id="keterangan"
                            value="<?= $data_modul['keterangan']; ?>" autocomplete="off">
                        </div>
                        <div class="form-group">
                        ...
                        <div style="display: none;" class="form-group">
                          ...
                          <input type="text" class="form-control" required name="gambarawal" id="gambarawal"
                            value="<?= $data_modul['gambar']; ?>" autocomplete="off">
                        </div>
                      </div>
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" required name="tujuan" id="tujuan"
                            value="<?= $data_modul['tujuan']; ?>" autocomplete="off">
                        </div>
                        <div class="form-group">
                          ...
                          <input type="number" class="form-control" required name="harga" id="harga"
                            value="<?= $data_modul['harga']; ?>" autocomplete="off">
                        </div>
                        <div class="form-group">
                          ...
                          <select class="form-control" required name="id_jenismodul" id="id_jenismodul" disabled>
                            <option value="3" <?= ($data_modul['id_jenismodul'] == 3) ? 'selected' : ''; ?>>Website Development
                            </option>
                            <option value="4" <?= ($data_modul['id_jenismodul'] == 4) ? 'selected' : ''; ?>>Machine Learning
                            </option>
                            <option value="5" <?= ($data_modul['id_jenismodul'] == 5) ? 'selected' : ''; ?>>Mobile Development
                            </option>
                            <option value="6" <?= ($data_modul['id_jenismodul'] == 6) ? 'selected' : ''; ?>>Database</option>
                            <option value="7" <?= ($data_modul['id_jenismodul'] == 7) ? 'selected' : ''; ?>>Network Security
                            </option>
                            <option value="8" <?= ($data_modul['id_jenismodul'] == 8) ? 'selected' : ''; ?>>Game Development
                            </option>
                          </select>
                        </div>
