  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="collapse navbar-collapse h-100 w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link <?php echo (basename($_SERVER['PHP_SELF']) == 'course' || basename($_SERVER['PHP_SELF']) == 'course.php' || basename($_SERVER['PHP_SELF']) == 'editmateri.php') ? 'active' : ''; ?>"
            href="../pages/course">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                  ...
                  <form action="proses.php?aksi=editmateri" method="POST" id="materiForm" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      <input type="hidden" class="form-control" name="id_modul" id="id_modul"
                        value="<?= $data_modul['id_modul']; ?>" autocomplete="off">
                    </div>
                    <div class="form-group">
                      <input type="hidden" class="form-control" name="id_bab" id="id_bab" value="<?= $id_bab; ?>"
                        autocomplete="off">
                    </div>
                    <div class="form-group">
                      <input type="hidden" class="form-control" name="id_materi" id="id_materi"
                        value="<?= $data_materi['id_materi']; ?>" autocomplete="off">
                    </div>
                    <div class="form-group">
                      <label class="text-lg font-weight-bold" for="judul">Judul</label>
                      <input type="text" class="form-control" name="judul" id="judul" value="<?= $data_materi['judul']; ?>"
                        autocomplete="off">
                    </div>
                    <div class="form-group">
                      <label class="text-lg font-weight-bold" for="materi">Materi</label>
                      <textarea style="height: 300px;" class="form-control" name="materi"
                        id="materi"> <?= $data_materi['materi']; ?>  </textarea>
                    </div>
                    <div class="form-group d-none">
                      <label class="text-lg font-weight-bold" for="gambarawal">link gmbr</label>
                      <input type="text" class="form-control" name="gambarawal" id="gambarawal" autocomplete="off"
                        value="<?= $data_materi['gambar']; ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <input type="hidden" class="form-control" name="id_subbab" id="id_subbab"
                        value="<?php echo isset($id_subbab) ? $id_subbab : ''; ?>" autocomplete="off" readonly>
                    </div>
