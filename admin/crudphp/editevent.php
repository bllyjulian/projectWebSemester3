                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" required name="judul_event" id="judul_event"
                            value="<?= $data_event['judul_event']; ?>" autocomplete="off">
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" required name="keterangan" id="keterangan"
                            value="<?= $data_event['keterangan']; ?>" autocomplete="off">
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" required name="lokasi" id="lokasi"
                            value="<?= $data_event['lokasi']; ?>" autocomplete="off">
                        </div>
                        <div class="form-group">
                        ...
                        <div style="display: none;" class="form-group">
                          ...
                          <input type="text" class="form-control" required name="gambarawal" id="gambarawal"
                            value="<?= $data_event['gambar']; ?>" autocomplete="off">
                        </div>
                      </div>
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="number" class="form-control" required name="kuota" id="kuota"
                            value="<?= $data_event['kuota']; ?>" autocomplete="off">
                        </div>
                        <div class="form-group">
                          ...
                          <select class="form-control" required name="pelaksanaan" id="pelaksanaan">
                            <option value="Daring" <?= ($data_event['pelaksanaan'] == 'Daring') ? 'selected' : ''; ?>>Daring
                            </option>
                            <option value="Luring" <?= ($data_event['pelaksanaan'] == 'Luring') ? 'selected' : ''; ?>>Luring
                            </option>
                            <option value="Hybrid" <?= ($data_event['pelaksanaan'] == 'Hybrid') ? 'selected' : ''; ?>>Hybrid
                            </option>
                          </select>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" required name="link_pendaftaran" id="link_pendaftaran"
                            value="<?= $data_event['link_pendaftaran']; ?>" autocomplete="off">
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <input type="date" class="form-control" required name="tanggal" id="tanggal"
                            value="<?= $data_event['tanggal']; ?>" autocomplete="off">
                        </div>
                      </div>
                    </div>
