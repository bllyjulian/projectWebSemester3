  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="collapse navbar-collapse h-100 w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link <?php echo (basename($_SERVER['PHP_SELF']) == 'course' || basename($_SERVER['PHP_SELF']) == 'course.php' || basename($_SERVER['PHP_SELF']) == 'tambahmateri.php') ? 'active' : ''; ?>"
            href="../pages/course">
            <div
              class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                if ($data_modul) {
                  ...
                  <form action="proses.php?aksi=tambahmateri" method="POST" id="materiForm">
                    ...
                    <div class="form-group mt-2">
                      <button style="height: 55px;" type="button" class="btn btn-primary btn-md btn-block w-100"
                        id="tambahInput">
                        Tambah
                      </button>
                    </div>
                    ...
                    <!-- Tombol submit -->
                    <div class="form-group mt-2">
                      <button style="height: 55px;" type="submit" class="btn btn-success btn-md btn-block w-100"
                        id="submit">
                        Simpan
                      </button>
                    </div>
