...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse h-100 w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
        <a class="nav-link <?php echo (basename($_SERVER['PHP_SELF']) == '      Semua.php' || basename($_SERVER['PHP_SELF']) == 'tambahakun.php' || basename($_SERVER['PHP_SELF']) == 'editakun.php') ? 'active' : ''; ?>" href="../pages/akunSemua.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
        <a class="nav-link <?php echo (basename($_SERVER['PHP_SELF']) == 'course' || basename($_SERVER['PHP_SELF']) == 'course.php' || basename($_SERVER['PHP_SELF']) == 'tambahmodul.php') ? 'active' : ''; ?>" href="../pages/course">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
  ...
  <input type="file" class="form-control" name="gambar" id="gambar" placeholder="">
    ...
    <div class="form-group">
            ...
            <input type="text" class="form-control" required name="tujuan" id="tujuan" placeholder="" autocomplete="off">
        </div>
        <div class="form-group">
            <label class="text-lg font-weight-bold" for="harga">Harga</label>
            <input type="number" class="form-control" required name="harga" id="harga" placeholder="" autocomplete="off">
        </div>
        <div class="form-group">
...
<script>
    ...
    if (response.sukses) {
        Swal.fire(
            ...
            window.location.href = '../pages/course.php'; // Ganti dengan halaman yang sesuai
        });
    } else {
        Swal.fire({
            icon: 'error',
