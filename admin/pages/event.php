              ...
              <div class="row">
                ...
                <div class="col-lg-6 col-5 my-auto text-end">
                  <button class="btn bg-gradient-success"><a style="color: white;"
                      href="../crudphp/tambahevent.php">Tambah</a></button>
                  ...
                  <thead>
                    <tr>
                      <th style="width: 250px;"
                        class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Judul
                        Event<br>Keterangan</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">
                        Lokasi<br>Kuota</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Metode
                        pelaksanaan</th>
