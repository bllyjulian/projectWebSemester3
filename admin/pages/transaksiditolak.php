...
<body class="g-sidenav-show  bg-gray-100">
          ...
          <div class="card mb-4">
            ...
            <div class="card-header pb-0 d-flex justify-content-lg-between">
              ...
              <div class="row">
                  ...
                  $sql_count = "SELECT COUNT(DISTINCT id_transaksi) AS total_transaksi FROM tb_transaksi WHERE tb_transaksi.id_status= 4";
                  ...
                  echo '<span class="font-weight-bold ms-1">' . $total_data . ' Transaksi Ditolak</span>';
                  echo '</p>';
                  ?>
  ...
  <ul class="dropdown-menu dropdown-menu-end  px-2 py-3 me-sm-n4" aria-labelledby="dropdownMenuButton">
    ...
    <li><a class="dropdown-item filter-option" href="transaksiselesai" data-status="Selesai">Selesai</a></li>
      ...
      JOIN 
          tb_metodepembayaran ON tb_transaksi.id_pembayaran = tb_metodepembayaran.id_pembayaran WHERE tb_transaksi.id_status= 4 ORDER BY tb_transaksi.tanggal_transaksi DESC";
      ...
      JOIN 
          tb_user ON tb_transaksi.username = tb_user.username WHERE tb_transaksi.id_status= 4
