              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="d-flex flex-column h-100">
                    ...
                    <p class="mb-5">Platform aplikasi mobile dengan berbagai fitur termasuk kursus interaktif dan fitur
                      sosial untuk diskusi</p>
                ...
                <div class="col-lg-5 ms-auto text-center mt-5 mt-lg-0">
                  <div class="bg-gradient-primary border-radius-lg h-100">
                    ...
                    <div class="position-relative d-flex align-items-center justify-content-center h-100">
                      <img class="w-100 position-relative z-index-2 pt-4" src="../assets/img/logoputih.png"
                        alt="rocket">
                    </div>
                  </div>
                </div>
...
?>
  ...
  <script>
    ...
    // Fungsi untuk menentukan pesan salam berdasarkan waktu
    ...
    new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
          ...
          borderSkipped: false,
          backgroundColor: "#fff",
          data: [200, 250, 400, 450, 200, 100, 220, 500, 100, 400, 230, 500],
          maxBarThickness: 6
        },],
      },
      options: {
