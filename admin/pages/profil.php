...
<body class="g-sidenav-show bg-gray-100">
  ...
  <div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100">
    ...
    <label for="fileUpload">
        <img class="cursor-pointer border-radius-lg" src="<?php echo isset($_SESSION['USER_INFO']['foto_profil']) ? $_SESSION['USER_INFO']['foto_profil'] : ''; ?>" alt="profile_image" class="w-100 border-radius-lg shadow-sm">
    </label>
    ...
    <p class="mb-0 font-weight-bold text-sm">
        <h6 class="mb-1">
            <?php
            if (isset($_SESSION['USER_INFO']['id_lvl'])) {
                $id_lvl = $_SESSION['USER_INFO']['id_lvl'];
                if ($id_lvl == "SPA01") {
                    echo 'Super Admin';
                } elseif ($id_lvl == "ADM01") {
                    echo 'Admin';
        ...
        <div class="w-100">
          <div class="card h-100">
            <div class="card-header pb-0 p-3">
              <div class="row">
                ...
                <div class="col-md-4 text-end">
                  <a href="<?= "../crudphp/editprofil?username=" . $_SESSION['USER_INFO']['username']?>">
            ...
            <div class="card-body p-3">
              <span class="text-sm">
                Halo, <span>
                <?php echo isset($_SESSION['USER_INFO']['username']) ? $_SESSION['USER_INFO']['nama_lengkap'] : ''; ?>!
                </span>, Terima Kasih telah menjadi <span>
                <?php
            if (isset($_SESSION['USER_INFO']['id_lvl'])) {
                $id_lvl = $_SESSION['USER_INFO']['id_lvl'];
                if ($id_lvl == "SPA01") {
            ...
            ?>
                ...
                </span>  di perusahaan kami. Kami sangat menghargai kontribusi dan dedikasi Anda.
    Berikut adalah data profil kamu, semoga informasi ini bermanfaat bagi Anda.
          </span>
              ...
              <ul class="list-group">
                ...
                <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Nomor Hp:</strong> &nbsp;
                ...
                <?php echo isset($_SESSION['USER_INFO']['username']) ? $_SESSION['USER_INFO']['jenis_kelamin'] : ''; ?> </li>
              </ul>
            </div>
          </div>
        </div>
  ...
  <script>
        ...
        document.getElementById('fileUpload').click(); // Ketika gambar diklik, pemicu unggah file
    });
