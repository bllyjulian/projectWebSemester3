                    ...
                    <div class="card card-blog card-plain border-radius-xl">
                      <div class="position-relative">
                        <a class="d-block border-radius-xl" style="width: 100%; height: 150px;">
                          <img src="<?= $r->gambar; ?>" alt="gambar modul" class="img-fluid border-radius-xl"
                  ...
                  <div class="card h-100 card-plain border">
                    <div class="card-body d-flex flex-column justify-content-center text-center">
                      <a href="../crudphp/tambahmodul">
                        ...
                        <h5 class=" text-secondary"> Tambah Modul </h5>
                      </a>
                    </div>
                  </div>
                </div>
